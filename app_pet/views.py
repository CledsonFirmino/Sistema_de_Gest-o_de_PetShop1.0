...
def cliente(request):
    dados_cliente = {"dados_cliente": Cadastro_cliente.objects.all()}
    return render(request, "cad_clientes/clientes.html", context=dados_cliente)


def detalhe_cliente(request, id_cliente):
    dados_c = {"dados": Cadastro_cliente.objects.get(pk=id_cliente)}
...
def criar_cliente(request):
    if request.method == "POST":
        ...
        form_cliente = {"form_cliente": cliente_form}
...
def editar_cliente(request, id_cliente):
    ...
    if request.method == "GET":
        ...
        return render(
            request, "cad_clientes/novo_cliente.html", {"form_cliente": form_cliente}
        )
...
# ---------------------------------------------------------------------------------
def pet(request):
    dados_pet = {"dados_pet": Cadastro_pet.objects.all()}
    return render(request, "cad_pets/pets.html", context=dados_pet)


def detalhe_pet(request, id_pet):
    dados_p = {"dados_p": Cadastro_pet.objects.get(pk=id_pet)}
...
def venda(request):
    dados_venda = {"dados_venda": Cadastro_venda.objects.all()}
    return render(request, "cad_vendas/vendas.html", context=dados_venda)


def detalhe_venda(request, id_venda):
    dados_v = {"dados_v": Cadastro_venda.objects.get(pk=id_venda)}
...
def criar_venda(request):
    if request.method == "POST":
        ...
        form_venda = {"form_venda": venda_form}
